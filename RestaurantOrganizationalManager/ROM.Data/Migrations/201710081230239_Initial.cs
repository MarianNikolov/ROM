    ...
    public partial class Initial : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.Table_Id, t.Product_Id })
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.TableProducts", "Product_Id", "dbo.Products");
            DropForeignKey("dbo.TableProducts", "Table_Id", "dbo.Tables");
            DropIndex("dbo.TableProducts", new[] { "Product_Id" });
            DropIndex("dbo.TableProducts", new[] { "Table_Id" });
